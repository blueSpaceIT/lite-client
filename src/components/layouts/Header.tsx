...
const OditiNavLink = ({ to, label, children }: Props) => {
    const className =
        "hover:text-primary hover:-translate-y-0.5 transition-all";
...
const OditiNav = ({
    ...
    return (
        <div
            ...
            } fixed lg:relative top-0 lg:block bg-white lg:bg-transparent z-50 w-[250px] lg:w-auto lg:right-0 h-full lg:h-auto p-7 lg:p-0 shadow-lg lg:shadow-none transition-all`}
        >
