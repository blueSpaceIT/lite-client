            ...
            <ContainerSM>
                ...
                <ol className="list-decimal pl-6">
                    <li>
                        General Use
                        <p>
                            By registering for and using the Oditi Career
                            ...
                            property on our platform are owned by Oditi Career
                        ...
                        <ul className="list-[disc] pl-6">
                            <li>
                                <p>
                                    ...
                                    sole discretion of Oditi Career.
                                </p>
                            </li>
                            <li>
                                <p>
                        ...
                        <ul className="list-[disc] pl-6">
                            ...
                            <li>
                                <p>
                                    ...
                                    grant Oditi Career a non-exclusive license
                        ...
                        <ul className="list-[disc] pl-6">
                            ...
                            <li>
                                <p>
                                    ...
                                    Services. Oditi Career is not liable for any
                    ...
                    <li>
                        ...
                        <ul className="list-[disc] pl-6">
                            <li>
                                <p>
                                    Oditi Career provides all Services “as is”
                            ...
                            <li>
                                <p>
                                    Oditi Career reserves the right to modify,
